...
const makeHttpRequest = async (
  ...
  try {
    ...
    const response = await nodePonyfill(finalUrl, fetchOptions);
...
const ACCOUNT_FAVORITE_MOVIES = '/account/:id/favorite/movies';
const ACCOUNT_FAVORITE_TV_SHOWS = '/account/:id/favorite/tv';
const ACCOUNT_LISTS = '/account/:id/lists';
const ACCOUNT_MARK_AS_FAVORITE = '/account/:id/favorite';
const ACCOUNT_MOVIE_WATCHLIST = '/account/:id/watchlist/movies';
const ACCOUNT_RATED_MOVIES = '/account/:id/rated/movies';
const ACCOUNT_RATED_TV_SHOWS = '/account/:id/rated/tv';
const ACCOUNT_RATED_TV_SHOWS_EPISODES = '/account/:id/rated/tv/episodes';
const ACCOUNT_TV_SHOW_WATCHLIST = '/account/:id/watchlist/tv';
...
const ACCOUNT_FAVORITE_MOVIES$1 = '/account/:id/movie/favorites';
const ACCOUNT_FAVORITE_TV_SHOWS$1 = '/account/:id/tv/favorites';
...
const ACCOUNT_MOVIE_WATCHLIST$1 = '/account/:id/movie/watchlist';
const ACCOUNT_RATED_MOVIES$1 = '/account/:id/movie/rated';
const ACCOUNT_RATED_TV_SHOWS$1 = '/account/:id/tv/rated';
const ACCOUNT_TV_SHOW_RECOMMENDATIONS =
  '/account/:id/tv/recommendations';
const ACCOUNT_TV_SHOW_WATCHLIST$1 = '/account/:id/tv/watchlist';
 ...
 */
const favoriteMovies = async (accountId, options = {}) => {
 ...
 */
const favoriteTvShows = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const lists = async (accountId, options = {}) => {
 ...
 */
const movieWatchlist = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const ratedMovies = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const ratedTvShows = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const ratedTvEpisodes = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const tvShowWatchlist = async (accountId, options = {}) => {
  const { session_id, language, page, sort_by } = options;
  if (!accountId && accountId !== 0) {
    return Promise.reject('An accountId has to be provided');
  }
 ...
 */
const details$1 = async (collectionId, options = {}) => {
 ...
 */
const images = async (collectionId, options = {}) => {
  const { language } = options;
  if (!collectionId && collectionId !== 0) {
    return Promise.reject('A collectionId has to be provided');
  }
 ...
 */
const translations = async (collectionId, options = {}) => {
  const { language } = options;
  if (!collectionId && collectionId !== 0) {
    return Promise.reject('A collectionId has to be provided');
  }
 ...
 */
const alternativeNames = async companyId => {
 ...
 */
const details$2 = async companyId => {
  if (!companyId && companyId !== 0) {
    return Promise.reject('A companyId has to be provided');
  }
 ...
 */
const images$1 = async companyId => {
  if (!companyId && companyId !== 0) {
    return Promise.reject('A companyId has to be provided');
  }
 ...
 */
const details$3 = async creditId => {
  if (!creditId) {
 ...
 */
const ratedTvEpisodes$1 = async (guestSessionId, options = {}) => {
  const { language, sort_by } = options;
  if (!guestSessionId) {
    return Promise.reject('A guestSessionId has to be provided');
  }
 ...
 */
const details$4 = async keywordId => {
 ...
 */
const movies$2 = async (keywordId, options = {}) => {
 ...
 */
const create = async (sessionId, body = {}) => {
 ...
 */
const details$5 = async (listId, options = {}) => {
  const { language } = options;
  if (!listId) {
    return Promise.reject('A listId has to be provided');
  }
 ...
 */
const itemStatus = async (listId, options = {}) => {
 ...
 */
const remove = async (listId, options = {}) => {
 ...
 */
const accountStates = async (movieId, options = {}) => {
 ...
 */
const alternativeTitles = async (movieId, options = {}) => {
 ...
 */
const changes = async (movieId, options = {}) => {
 ...
 */
const deleteRating = async (movieId, options = {}) => {
  const { session_id, guest_session_id } = options;
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const details$6 = async (movieId, options = {}) => {
 ...
 */
const externalIds = async movieId => {
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const images$2 = async (movieId, options = {}) => {
 ...
 */
const rate = async (movieId, rating, options = {}) => {
  const { session_id, guest_session_id } = options;
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const recommendations = async (movieId, options = {}) => {
  const { language, page } = options;
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const reviews = async (movieId, options = {}) => {
  const { language, page } = options;
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const similar = async (movieId, options = {}) => {
  const { language, page } = options;
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const translations$1 = async movieId => {
  if (!movieId) {
    return Promise.reject('A movieId has to be provided');
  }
 ...
 */
const alternativeNames$1 = async networkId => {
  if (!networkId && networkId !== 0) {
    return Promise.reject('A networkId has to be provided');
  }
 ...
 */
const images$3 = async networkId => {
  if (!networkId && networkId !== 0) {
    return Promise.reject('A networkId has to be provided');
  }
 ...
 */
const changes$1 = async (personId, options = {}) => {
  const { start_date, end_date, page } = options;
 ...
 */
const details$8 = async (personId, options = {}) => {
  const { language, append_to_response, include_image_language } = options;
 ...
 */
const externalIds$1 = async (personId, options = {}) => {
  const { language } = options;
 ...
 */
const translations$2 = async (personId, options = {}) => {
  const { language } = options;
 ...
 */
const details$9 = async reviewId => {
  if (!reviewId) {
 ...
 */
const accountStates$1 = async (tvId, options = {}) => {
 ...
 */
const alternativeTitles$1 = async (tvId, options = {}) => {
  const { language } = options;
 ...
 */
const credits$1 = async (tvId, options = {}) => {
  const { language } = options;
 ...
 */
const details$a = async (tvId, options = {}) => {
  const { language, append_to_response, include_image_language } = options;
 ...
 */
const images$5 = async (tvId, options = {}) => {
  const { language, include_image_language } = options;
 ...
 */
const recommendations$1 = async (tvId, options = {}) => {
  const { language, page } = options;
 ...
 */
const reviews$1 = async (tvId, options = {}) => {
  const { language, page } = options;
 ...
 */
const similar$1 = async (tvId, options = {}) => {
  const { language, page } = options;
 ...
 */
const translations$3 = async (tvId, options = {}) => {
  const { language } = options;
 ...
 */
const videos$1 = async (tvId, options = {}) => {
  const { language } = options;
 ...
 */
const changes$3 = async (episodeId, options = {}) => {
  const { start_date, end_date, page } = options;
 ...
 */
const credits$2 = async (tvId, seasonNumber, episodeNumber) => {
  if (!tvId && tvId !== 0) {
    return Promise.reject('A tvId has to be provided');
  }
 ...
 */
const externalIds$3 = async (tvId, seasonNumber, episodeNumber) => {
  if (!tvId && tvId !== 0) {
    return Promise.reject('A tvId has to be provided');
  }
 ...
 */
const translations$4 = async (tvId, seasonNumber, episodeNumber) => {
  if (!tvId && tvId !== 0) {
    return Promise.reject('A tvId has to be provided');
  }
 ...
 */
const details$c = async (id, options = {}) => {
  const { language } = options;
 ...
 */
const accountStates$3 = async (tvId, seasonNumber, options = {}) => {
 ...
 */
const changes$4 = async (seasonId, options = {}) => {
  const { start_date, end_date, page } = options;
 ...
 */
const credits$3 = async (tvId, seasonNumber, options = {}) => {
  const { language } = options;
 ...
 */
const details$d = async (tvId, seasonNumber, options = {}) => {
  const { language, append_to_response, include_image_language } = options;
 ...
 */
const externalIds$4 = async (tvId, seasonNumber, options = {}) => {
  const { language } = options;
 ...
 */
const images$7 = async (tvId, seasonNumber, options = {}) => {
  const { language, include_image_language } = options;
 ...
 */
const videos$3 = async (tvId, seasonNumber, options = {}) => {
  const { language } = options;
 ...
 */
const favoriteMovies$1 = async (accessToken, accountId, options = {}) => {
 ...
 */
const favoriteTvShows$1 = async (accessToken, accountId, options = {}) => {
  const { page, sort_by } = options;
 ...
 */
const lists$2 = async (accessToken, accountId, options = {}) => {
  const { page } = options;
 ...
 */
const movieWatchlist$1 = async (accessToken, accountId, options = {}) => {
  const { page, sort_by } = options;
 ...
 */
const ratedMovies$2 = async (accessToken, accountId, options = {}) => {
  const { page, sort_by } = options;
 ...
 */
const ratedTvShows$2 = async (accessToken, accountId, options = {}) => {
  const { page, sort_by } = options;
 ...
 */
const tvShowWatchlist$1 = async (accessToken, accountId, options = {}) => {
  const { page, sort_by } = options;
 ...
 */
const create$1 = async (accessToken, options = {}) => {
 ...
 */
const details$e = async (accessToken, listId, options = {}) => {
 ...
 */
const itemStatus$1 = async (accessToken, listId, item = {}) => {
 ...
 */
const remove$1 = async (accessToken, listId) => {
  if (!accessToken) {
    return Promise.reject('An accessToken has to be provided');
  }
